...
<html>
<head>
    <title>Set Application Deadline</title>
    <style>
        body {
            background: #f7f7f9;
...
<div class="container">
    <div class="top-line">
        <h1 class="page-title">Set Application Deadline</h1>
        <a class="back-link" href="<%= response.encodeURL("AdminController?action=dashboard") %>">Back to Dashboard</a>
    </div>

    <div class="desc-box">
        Please set the deadline for TA resume submission. After the first deadline passes,
        TAs will no longer be allowed to submit resumes until the second waitlist application period opens.
    </div>
    ...
    <div class="form-card">
        ...
        <form action="<%= response.encodeURL("AdminController") %>" method="post">
            ...
            <div class="form-row">
                <label class="form-label" for="deadlineDate">First Round Deadline Date</label>
                <input
                        ...
                        required>
                 <div class="hint-text">
                    Enter the closing date for the first round of TA applications.
                </div>
             </div>

            <div class="form-row">
                <label class="form-label" for="deadlineTime">First Round Deadline Time</label>
                <input
                        class="form-input deadline-input"
                        type="time"
                        id="deadlineTime"
                        ...
                        required>
                <div class="hint-text">
                    Set the exact closing time for the first round. After this time, resume submission will be closed until the waitlist period begins.
                </div>
            </div>
