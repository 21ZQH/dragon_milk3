...
<head>
    ...
    <style>
        ...
        .dashboard-title { color: #1f2a44 !important; font-size: 34px !important; font-weight: 700 !important; line-height: 1.2 !important; text-align: left !important; margin: 0 0 8px !important; }
        .dashboard-welcome { color: #5f6f85; font-size: 16px; margin: 0 0 26px; }
        ...
        .dashboard-card-disabled, .dashboard-card-disabled:hover { border-color: #d7dee8 !important; background: #fff !important; }
...
<main class="dashboard-main">
    ...
    <div class="dashboard-list">
        <a href="<%= response.encodeURL("MOclasscontroller?action=my_project") %>" class="dashboard-card">
            ...
            <div class="dashboard-card-meta">Open assigned courses, inspect recruitment details, and edit published information before the MO deadline.</div>
        </a>
